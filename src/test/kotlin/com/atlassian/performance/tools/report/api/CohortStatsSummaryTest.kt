...
class CohortStatsSummaryTest {
    ...
    fun shouldAggregateAverage() {
        ...
        CohortStatsSummary(report, labels).report(listOf(stats))
    ...
    fun shouldCreateReport() {
        ...
        CohortStatsSummary(report, labels).report(stats)
    ...
    private fun PerformanceStats.withProperties(
        ...
        cohort = cohort,
        sampleSizes = sampleSizes ?: emptyMap(),
        locations = centers ?: emptyMap(),
        dispersions = dispersions ?: emptyMap(),
